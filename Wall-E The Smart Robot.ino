...
else if(bt_ir_data == 9){mode=1; Speed=80;} //Auto Line Follower Command
else if(bt_ir_data ==10){mode=2; Speed=225;} //Auto Obstacle Avoiding Command
...
long IRremote_data(){
     if(results.value==0x1020 ) {IR_data=1;  }  
else if(results.value==0x1021 ) {IR_data=2; } 
else if(results.value==0x1811 ) {IR_data=3;  } 
else if(results.value==0x1810 ) {IR_data=4; } 
else if(results.value==0x1025 || results.value==0xFFB04F){IR_data=5;} 
else if(results.value==0x180D) {IR_data=8;} 
else if(results.value==0x1838) {IR_data=9;} 
else if(results.value==0x183B) {IR_data=10;} 
return IR_data;
}
